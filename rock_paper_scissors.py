...
def play_game():
    ...
    if player1_roll > player2_roll:
        print("Player 1 wins this game!") # If player ones roll is higher than player two, player one wins
        return 1, 0
    elif player2_roll > player1_roll:
        print("Player 2 wins this game!") # If player two rolls a higher number than he wins
        return 0, 1
    else:
